...
namespace Business.Handlers.Members
{
  public class DemoteMemberHandler : IPipelineBehavior<DemoteMemberCommand, ApiResponse<Member>>
  {
    ...
    public async Task<ApiResponse<Member>> Handle(DemoteMemberCommand request, CancellationToken cancellationToken, RequestHandlerDelegate<ApiResponse<Member>> next)
    {
