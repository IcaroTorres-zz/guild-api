...
namespace Tests.Application.Members.Commands.LeaveGuild
{
    ...
    public class LeaveGuildHandlerTests
    {
        ...
        {
            // arrange
            var leavingMaster = (MemberTestProxy)MemberFake.GuildLeader().Generate();
            var expectedNewLeader = leavingMaster.GetGuild().GetVice();
            ...
            expectedFinishedMembership.Should().BeOfType<MembershipTestProxy>();
