...
namespace Persistence.Repositories
{
        ...
        where TDataEntity : TDomainEntity
    {
        ...
        public async Task<Pagination<TDomainEntity>> PaginateAsync(IQueryable<TDomainEntity> query = null, int top = 20, int page = 1, CancellationToken cancellationToken = default)
        {
