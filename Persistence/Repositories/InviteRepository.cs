...
namespace Persistence.Repositories
{
    public sealed class InviteRepository : IInviteRepository
    {
        ...
        public Task<bool> IsPendingAsync(Guid id, CancellationToken cancellationToken = default)
        {
            return _baseRepository.ExistsAsync(x => x.Id.Equals(id) && x.Status == InviteStatuses.Pending);
        }
